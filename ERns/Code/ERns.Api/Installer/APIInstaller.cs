...
using ElmahCore.Mvc;
using ElmahCore;
using ERns.Api.Filters;
using ERns.BusinessServices.Installer;

namespace ERns.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ERns API", Version = version + "-" + branch});
            });
