...
using ElmahCore.Mvc;
using ElmahCore;
using EApp.Api.Filters;
using EApp.BusinessServices.Installer;

namespace EApp.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "EApp API", Version = version + "-" + branch});
            });
